...
module.exports = class Validator extends EventEmitter {
    ...
    constructor(model, variables) {
        ...
        if (this.model.interval)
            this.cronHandle = interval.check(this.model.interval * 1000, () => this.execute());
    ...
    execute() {
        try {
            const ctx = _.cloneDeep(this.variables) //Object.assign({}, this.variables, this.variables.values())
