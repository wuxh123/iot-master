...
var file_plugin_proto_rawDesc = []byte{
	...
	0x2f, 0x0a, 0x0b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x50, 0x61, 0x63, 0x6b, 0x12, 0x0e,
	...
	,
...
var file_plugin_proto_depIdxs = []int32{
	...
	2, // 1: plugin.Plugin.Request:input_type -> plugin.RequestPack
	1, // 2: plugin.Plugin.Register:output_type -> plugin.RegisterResp
	3, // 3: plugin.Plugin.Request:output_type -> plugin.ResponsePack
...
type PluginClient interface {
	...
	Request(ctx context.Context, opts ...grpc.CallOption) (Plugin_RequestClient, error)
}
...
func (c *pluginClient) Request(ctx context.Context, opts ...grpc.CallOption) (Plugin_RequestClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Plugin_serviceDesc.Streams[0], "/plugin.Plugin/Request", opts...)
	if err != nil {
		return nil, err
	}
	x := &pluginRequestClient{stream}
	return x, nil
}

type Plugin_RequestClient interface {
	Send(*RequestPack) error
	Recv() (*ResponsePack, error)
	grpc.ClientStream
}

type pluginRequestClient struct {
	grpc.ClientStream
}

func (x *pluginRequestClient) Send(m *RequestPack) error {
	return x.ClientStream.SendMsg(m)
}

func (x *pluginRequestClient) Recv() (*ResponsePack, error) {
	m := new(ResponsePack)
...
type PluginServer interface {
	...
	Request(Plugin_RequestServer) error
}
...
func (*UnimplementedPluginServer) Request(Plugin_RequestServer) error {
...
func _Plugin_Request_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PluginServer).Request(&pluginRequestServer{stream})
}

type Plugin_RequestServer interface {
	Send(*ResponsePack) error
	Recv() (*RequestPack, error)
	grpc.ServerStream
}

type pluginRequestServer struct {
	grpc.ServerStream
}

func (x *pluginRequestServer) Send(m *ResponsePack) error {
	return x.ServerStream.SendMsg(m)
}

func (x *pluginRequestServer) Recv() (*RequestPack, error) {
	m := new(RequestPack)
...
var _Plugin_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "Request",
			Handler:       _Plugin_Request_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
